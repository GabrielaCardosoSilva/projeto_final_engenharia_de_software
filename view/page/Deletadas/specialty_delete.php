...
<head>
    ...
    <title>Excluir especialidades</title>
...
<body>
    ...
    <div class="grid-container">
        ...
        <div class="title">
            ...
            <h1 class="h1-title">Selecionar especialidades para exclusão</h1>
        </div>
