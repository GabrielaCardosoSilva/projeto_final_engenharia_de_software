...
<head>
    ...
    <title>Excluir cadastros de médicos</title>
...
<body>
    ...
    <div class="grid-container">
        ...
        <div class="title">
            ...
            <h1 class="h1-title">Selecionar cadastros de médicos para exclusão</h1>
        </div>
