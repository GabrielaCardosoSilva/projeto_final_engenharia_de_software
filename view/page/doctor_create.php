    ...
    <div class="grid-container">
        ...
        <div class="model" id="model-help">
            <div class="model-popup-help">
                ...
                <p class="p-popup">Atenção aos campos marcados com um asterisco (*), pois eles são de preenchimento obrigatório e não será possível cadastrar um médico(a) se eles estiverem vazios.</p>
