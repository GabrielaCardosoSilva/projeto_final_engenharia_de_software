    ...
    <div class="grid-container">
        ...
        <div class="model" id="model-help">
            <div class="model-popup-help">
                ...
                <p class="p-popup">Para alterar o cadastro de um paciente, preencha os campos que aparecem na tela e clique no botão inferior direito escrito "Salvar".</p>
                <p class="p-popup">Atenção aos campos marcados com um asterisco (*), pois eles são de preenchimento obrigatório e não será possível alterar o cadastro se eles estiverem vazios.</p>
        ...
        <div class="title">
            ...
            <h1 class="h1-title">Alterar dados cadastrais de pacientes</h1>
            <p class="p-title">Para alterar os dados de pacientes, preencha os campos abaixo e clique em salvar.</p>
        </div>
